...
function App() {
  ...
  const loveStartDate = new Date('2025-04-13');
  ...
  const createFloatingHearts = () => {
    ...
    function addHeart() {
      ...
      heart.style.animation = `float ${Math.random() * 3 + 4}s linear infinite`;
      heart.style.pointerEvents = 'none';
  ...
  const createMusicNotes = () => {
    ...
    function addMusicNote() {
      ...
      note.style.animation = `musicFloat ${Math.random() * 2 + 5}s linear infinite`;
          ...
          <div className="love-screen">
            ...
            <div className="bg-white/95 rounded-2xl sm:rounded-3xl p-6 sm:p-10 mb-6 sm:mb-8 shadow-2xl backdrop-blur-sm">
              ...
              <ul className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <li 
                    key={index}
                    className="memory-item bg-gradient-to-r from-yellow-200 to-orange-200 p-4 sm:p-5 rounded-xl sm:rounded-2xl text-gray-800 text-base sm:text-lg shadow-md transform translate-x-[-20px] opacity-0"
                  >
                    {memory}
                  </li>
                ))}
            ...
            <div className="button-grid flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
              ...
              <button
                ...
                className="bg-gradient-to-r from-red-500 to-pink-500 text-white px-4 sm:px-6 py-3 rounded-full text-base sm:text-lg font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 flex items-center gap-2 justify-center"
              >
                <Sparkles size={18} />
                💥 Kalp Patlaması
              </button>
